...
*/
    var parser = (function () {
        var o = function (k, v, o, l) {
            ...
            $Vg = [1, 22],
            $Vh = [1, 23],
            $Vi = [4, 6, 7, 9, 10, 11, 12, 13, 14, 15, 16, 17, 19],
            $Vj = [4, 6, 7, 9, 10, 11, 12, 13, 14, 15, 16, 17, 19, 26],
            $Vk = [4, 6, 7, 19];
        var parser = {
            ...
            performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate /* action[1] */ , $$ /* vstack */ , _$ /* lstack */ ) { /* this == yyval */
                ...
                case 21:
                    ...
                    this.$ = new Ast.Identifier(id, null);
                ...
                case 22:
                    ...
                    this.$ = new Ast.Identifier(id, $$[$0 - 2]);
            ...
            o($Vi, [2, 16], {
                26: [1, 26]
            }), o($Vi, [2, 17]), o($Vi, [2, 18]), o($Vi, [2, 19]), o($Vi, [2, 20]), o($Vj, [2, 21]),
            {
                1: [2, 2]
            },
            {
            ...
            o($Vk, [2, 3], {
                ...
                16: $Vg,
                17: $Vh
            }), o($Vi, [2, 6]), o($Vi, [2, 7]), o($Vi, [2, 8]), o($Vi, [2, 9]), o($Vi, [2, 10]), o($Vi, [2, 11]), o($Vi, [2, 12]), o($Vi, [2, 13]), o($Vi, [2, 14]), o($Vi, [2, 15]), o($Vj, [2, 22])],
            defaultActions: {
                2: [2, 1],
                12: [2, 2]
            },
        ...
        var lexer = (function () {
            var lexer = ({
                ...
                rules: [/^(?:\s+)/i, /^(?:\.)/i, /^(?:&|&&|AND\b)/i, /^(?:\||\|\||OR\b)/i, /^(?:!=)/i, /^(?:<=)/i, /^(?:>=)/i, /^(?:<)/i, /^(?:>)/i, /^(?:~=|LIKE\b)/i, /^(?:==|IS\b)/i, /^(?:=)/i, /^(?:IN\b)/i, /^(?:!)/i, /^(?:\()/i, /^(?:\))/i, /^(?:\d+(\.\d+)?\b)/i, /^(?:false|true\b)/i, /^(?:null\b)/i, /^(?:(\$)((\w[\w\d_]*)|("(?:\\[\"bfnrt/\\]|\\[a-fA-F0-9]{4}|[^\"\\])*"))?)/i, /^(?:(\w[\w\d_]*)|("(?:\\[\"bfnrt/\\]|\\[a-fA-F0-9]{4}|[^\"\\])*"))/i, /^(?:$)/i, /^(?:.)/i],
                conditions: {
                    "INITIAL": {
